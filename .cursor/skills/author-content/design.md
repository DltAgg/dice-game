...
- **Proving cards (already in catalogue):** Arcane — Insight Rune, Living Library, Consult. Darkness — Dark Pact, Bury the Name, Grave Whisper. Luminar — Glimmer and prevent package (spec `009`). Corruption — Great Contamination, Wasting Brand, face-marker suite. Toxin — Dose / Venom / apply-toxin package. Martial — War Charge swap, Command face, Dress Ranks. Mechanical — Assembly Line, Die Press, Reforge, Stamp, Coupling. Wild — Share the Kill, Den Share, Pack Share (spec `015`).
