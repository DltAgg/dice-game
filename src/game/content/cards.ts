...
const DEFINITIONS: readonly CardDefinition[] = [
  ...
  card({
    ...
    effect: {
      effects: [{ type: "search-graveyard", amount: 1, maxPlayCost: 2 }],
    },
  }),
  card({
    id: REFORGE,
  ...
  card({
    ...
    effect: {
      effects: [{ type: "generate-symbol", symbol: "arcane", amount: 1 }, { type: "peek-deck-optional-bottom" }],
    },
  }),
  card({
    id: WARDING_CHARM,
