...
const DEFINITIONS: readonly FaceCardDefinition[] = [
  ...
  namedSynthetic(
      ...
      "On absorb: it may perform a Basic Attack if it has not attacked this turn.",
    {
      ...
      // Extra Basic Attack if not attacked this turn — no vocabulary yet.
      onAbsorb: [],
    },
  ),
  namedSynthetic(
  ...
  namedSynthetic(
    ...
    {
      // Adjacent-ally gate is not modelled — roll clause deferred.
      onRoll: [],
      onAbsorb: [
        { type: "reposition-creature", target: { kind: "choose-ally" } },
      ],
  ...
  namedSynthetic(
      ...
      "On absorb: remove 1 Shield from an enemy creature.",
    {
      ...
      // Enemy move banned — keep non-push absorb replacement.
      onAbsorb: [
